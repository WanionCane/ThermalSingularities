...
public final class ThermalSingularityItem extends ItemSingularity
{
    ...
    private static final int[] clearer = new int[]{0x69D6FC, 0x6499BC, 0xE55D00, 0xD8B44E, 0x107272};
    ...
    {
        return renderPass == 0 ? darker[getDamage(itemstack)] : clearer[getDamage(itemstack)];
    }
